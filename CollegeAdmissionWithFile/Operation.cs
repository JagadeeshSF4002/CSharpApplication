...
namespace CollegeAdmissionWithFile
{
    public static class Operation
    {
      ...
      public static event EventManager registration,login,subMenu,checkEligibility,showDetails,takeAdmission,cancelAdmission,showAdmissionDetails;
      ...
      {      
            ...
            checkEligibility = new EventManager(Operation.CheckEligibity);
            showDetails = new EventManager(Operation.ShowDetails);
            takeAdmission = new EventManager(Operation.TakeAdmission);
            cancelAdmission = new EventManager(Operation.CancelAdmission);
            showAdmissionDetails = new EventManager(Operation.ShowAdmissionDetails);
        }
     ...
     public static void CancelAdmission()
     {
      ...
      public static DepartmentDetails ValidateDepartmentID(string departmentID)
      {
        foreach(DepartmentDetails department in departmentList)
        {
      ...
      public static StudentDetails IsValidStudentID(string userID)
      {
